...
<script type="text/javascript">
	...
	var info_list_1  = { title: '草稿', path: '<%=request.getContextPath() %>/content/info/info_list.jsp?infoStatus=1' };
	var info_list_2  = { title: '审核中', path: '<%=request.getContextPath() %>/content/info/info_list.jsp?infoStatus=2' };
