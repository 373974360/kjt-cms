	...
	<body>
		            ...
		            <tr class="odd">
		                ...
		                <td>
			                <div name="group.infoData" class="mini-radiobuttonlist" repeatItems="1" repeatLayout="table" repeatDirection="vertical"
							    textField="text" valueField="id" dataField="infoRead" value="3"
		            ...
		            <tr>
		                ...
		                <td>
		                    <div name="group.sqData" class="mini-radiobuttonlist" repeatItems="1" repeatLayout="table" repeatDirection="vertical"
							    textField="text" valueField="id" dataField="sqRead" value="2"
	    ...
	    <script type="text/javascript">
	        ...
	        function SaveData() {
	            ...
	            $.ajax({
	                url: "com.cms.basics.GroupService.addGroup.biz.ext",
	                type: 'POST',
	                data: json,
	                cache: false,
