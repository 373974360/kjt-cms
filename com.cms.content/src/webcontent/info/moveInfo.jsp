...
<body>
    <div class="nui-fit"style="padding:5px">
        <ul id="funcTree" class="nui-tree" style="width:100%;height:100%;"
			...
			showTreeIcon="true" showTreeLines="true" expandOnDblClick="true" expandOnLoad="false" showRadioButton="true" showFolderCheckBox="false">
		</ul>
    </div>  
    ...
    <script type="text/javascript">
		...
		function SaveData() {
			...
			var json = nui.encode({infos:rows,catId:ids});
            $.ajax({
                url: "com.cms.content.ContentService.MoveInfo.biz.ext",
                type: 'POST',
                data: json,
                cache: false,
