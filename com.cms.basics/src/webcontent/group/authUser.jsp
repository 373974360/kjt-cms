	 ...
	 <table style="height:98%;width:100%">
	   <tr>
	    	...
	    	<div id="listbox1" class="nui-listbox" style="width:100%;height:100%;"
	            textField="NAME" valueField="ID" ajaxData="getAjaxData" multiSelect="true"
	         	...
	         	<div property="columns">
	               <div header="已关联用户" field="NAME" renderer="renderAuthorizedRoleList"></div>
	            </div>
	        </div>
	    </td>
	    <td style="width:20%;height:100%;text-align:center;">
	        ...
	        <input class="nui-button" text="全部关联" onclick="addAll()" style="width:65px;margin-top:5px;"/><br />
	        <input class="nui-button" text="关联" onclick="add()" style="width:65px;margin-top:5px;"/><br />
	    </td>
	    <td style="width:40%;height:100%;">
		   <div id="listbox2" class="nui-listbox" style="width:100%;height:100%;"
			   ...
			   dataField="unauthorizedRoleList">
				 <div property="columns">
				      <div header="未关联用户" field="NAME"></div>
				 </div>
			</div>
	    </td>
	    </tr>
...
<script type="text/javascript">
    ...
    var url1="com.cms.basics.GroupService.getUserAuthorizedRoleList.biz.ext";
    var url2="com.cms.basics.GroupService.getUserUnauthorizedRoleList.biz.ext";
    loadAuth();
    ...
    function saveData(items, fn){
	    ...
	    $.ajax({
	    	url: "com.cms.basics.GroupService.addGroupUser.biz.ext",
	    	cache: false,
	    	data: json,
	    	type: 'POST',
	...
	function deleteData(items, fn){
	    ...
	    $.ajax({
	    	url: "com.cms.basics.GroupService.deleteGroupUser.biz.ext",
	    	cache: false,
	    	data: json,
	    	type: 'POST',
	    	contentType:'text/json',
