...
<html>
	...
	<body style="width: 98%; height: 95%;">
		...
		<div class="nui-panel" title="群众来信列表" iconCls="icon-add" style="width: 100%; height: 85%;" showToolbar="false" showFooter="false">
		...
		<script type="text/javascript">
						...
						if (action == "ok") {
							...
							$.ajax({
								...
								success : function(text) {
									...
									if (returnJson.exception == null) {
										grid.reload();
										nui.alert("信件已"+ msg,"系统提示",function(action) {
										});
									} else {
										grid.unmask();
										nui.alert("信件已"+ msg,"系统提示");
									}
								}
							});
						}
			...
			function detailsRow(row_uid) {
				...
				var isPublish = row.isPublish ? row.isPublish : '';
				var isOpen = row.isOpen ? row.isOpen : '';
					nui.open({
						url : "<%=request.getContextPath()%>/commonality/sq/SqDetail.jsp?sqId="+row.id +"&isPublish=" +isPublish+"&isOpen=" +isOpen,
						title : "来信详情&处理",
						width : '80%',
						height : '100%',
						onload : function() {
