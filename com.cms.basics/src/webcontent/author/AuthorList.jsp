...
<html>
	...
	<body style="width: 98%; height: 95%;">
			...
			<div id="queryform" class="nui-form" align="center" style="height: 100%">
				...
				<table id="table1" class="table" style="height: 100%;float:left;">
					<tr>
						...
						<td colspan="1">
							<input class="nui-textbox" name="criteria/_expr[2]/authorName" onblur="this.value=this.value.replace(/^\s+|\s+$/g,'')"/>
		...
		<div class="nui-panel" title="作者列表" iconCls="icon-add" style="width: 100%; height: 85%;" showToolbar="false" showFooter="false">
			...
			<div class="nui-fit">
				<div id="datagrid1" dataField="author" class="nui-datagrid" style="width: 100%; height: 100%;"
					...
					<div property="columns">
						...
						<div field="authorName" headerAlign="center" allowSort="true">作者姓名</div>
						<div field="authorUrl" headerAlign="center" allowSort="true">博客地址</div>
					</div>
				</div>
			</div>
		</div>
