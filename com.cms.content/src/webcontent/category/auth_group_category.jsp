    ...
    <!--body-->
 	<div class="nui-fit" style="padding:0px 10px 10px 10px;">
		<ul id="funcTree" class="nui-tree" style="width:100%;height:100%;"
			url="com.cms.content.CategoryService.queryGroupAuthCategoryTreeNode.biz.ext"
...
<script type="text/javascript">
	...
	function setRoleId(){
		return {"groupId":"<%= request.getParameter("groupId")%>"};
	}
	...
	function saveTree(e){
        ...
        for(var i=0;i<array.length;i++){
        	if(i>0){
        		json+=',{"groupId":"'+groupId+'","categoryId":"'+array[i]+'"}';
        	}else{
        		json+='{"groupId":"'+groupId+'","categoryId":"'+array[i]+'"}';
        	}
        }
        json+='],"params":{"groupId":"'+groupId+'"}}';
        $.ajax({
            url: "com.cms.content.CategoryService.setAuthGroupCategory.biz.ext",
            type: 'POST',
            data: json,
            cache: false,
