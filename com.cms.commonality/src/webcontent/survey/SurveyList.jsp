			...
			<div class="nui-fit">
				<div id="datagrid1" dataField="survey" class="nui-datagrid" style="width: 100%; height: 100%;"
					...
					<div property="columns">
						...
						<div field="title" width="300" headerAlign="center" allowSort="true">标题</div>
						<div field="startTime" width="100" headerAlign="center" align="center" allowSort="true">开始时间</div>
						<div field="endTime" width="100" headerAlign="center" align="center" allowSort="true">截止时间</div>
