			...
			<table style="width: 100%; table-layout: fixed;"
				...
				<tr>
					<th class="nui-form-label">
						<label for="appfunction.funcname$text"> 作者姓名: </label>
					</th>
					<td>
						<input class="nui-textbox nui-form-input" name="author.authorName" />
					</td>
				</tr>
				<tr>
					<th class="nui-form-label">
						<label for="appfunction.funcname$text"> 博客地址: </label>
					</th>
					<td>
						<input class="nui-textbox nui-form-input" name="author.authorUrl" />
					</td>
				</tr>
			</table>
		</div>
