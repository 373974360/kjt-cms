	...
	<body>
	    ...
	    <script type="text/javascript">
	        ...
	        function setData(data){
	        	data = nui.clone(data);
	        	var json = nui.encode({interview:data});
				$.ajax({
					url:"com.cms.commonality.InterviewService.getInterview.biz.ext",
					type:'POST',
			         data:json,
			         cache:false,
			         ...
			         success:function(text){
						...
						if(obj.interview.content!=null){
							ue.setContent(obj.interview.content);
						}
			         }
	          	});
	        }
