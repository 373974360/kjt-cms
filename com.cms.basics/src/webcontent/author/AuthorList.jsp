  ...
  <body style="width:98%;height:95%;">
    <div class="nui-panel" title="作者查询" iconCls="icon-add" style="width:100%;height:15%;" showToolbar="false" showFooter="true">
      <div id="queryform" class="nui-form" align="center" style="height:100%">
        <!-- 数据实体的名称 -->
        <input class="nui-hidden" name="criteria/_entity" value="com.cms.basics.author.CmsAuthor">
        <!-- 排序字段 -->
        <input class="nui-hidden" name="criteria/_orderby[1]/_property" value="authorName">
        ...
        <table id="table1" class="table" style="height:100%;float:left;">
          <tr>
            ...
            <td colspan="1">
              <input class="nui-textbox" name="criteria/_expr[1]/authorName"/>
    ...
    <div class="nui-panel" title="作者列表" iconCls="icon-add" style="width:100%;height:85%;margin-top:10px;" showToolbar="false" showFooter="false" >
      ...
      <div class="nui-fit">
        ...
        url="com.cms.basics.AuthorService.queryAuthor.biz.ext" pageSize="10" showPageInfo="true" multiSelect="true" onselectionchanged="selectionChanged" allowSortColumn="false">
          <div property="columns">
            ...
            <div field="authorName" headerAlign="left" allowSort="true">
           作者姓名
            </div>
            <div field="authorUrl" headerAlign="left" allowSort="true" >
              博客地址
            </div>
          </div>
        </div>
    ...
    <script type="text/javascript">
      ...
      function add() {
        nui.open({
          url: "<%= request.getContextPath() %>/basics/author/AuthorAdd.jsp",
        ...
        if (row) {
          ...
          function remove(){
            ...
            if(rows.length > 0){
              ...
              function(action){
                if(action=="ok"){
                  var json = nui.encode({authors:rows});
