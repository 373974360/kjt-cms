	...
	<body>
	    ...
	    <script type="text/javascript">
	        ...
	        function setData(data){
	        	data = nui.clone(data);
	        	var json = nui.encode({collection:data});
				$.ajax({
					url:"com.cms.siteconfig.CollectionService.getCollection.biz.ext",
					type:'POST',
			         data:json,
			         cache:false,
	        ...
	        function SaveData() {
	            ...
	            $.ajax({
	                url: "com.cms.siteconfig.CollectionService.updateCollection.biz.ext",
	                type: 'POST',
	                data: json,
	                cache: false,
	                contentType:'text/json',
